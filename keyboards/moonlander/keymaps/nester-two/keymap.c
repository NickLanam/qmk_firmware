...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_BASE] = LAYOUT_moonlander(
    ...
    KC_LCTRL,       KC_LALT,        KC_LGUI,        KC_F11,         LALT_T(KC_QUOTE),               TO(5),                                          TO(4),                          LALT_T(KC_GRAVE),KC_F12,        KC_RGUI,        KC_RALT,        KC_RCTRL,       
  ...
  [LAYER_GAME] = LAYOUT_moonlander(
    ...
    _______,        _______,        KC_S,           KC_D,           KC_F,           _______,        SH_OS,                                          XXXXXXX,        _______,        KC_J,           KC_K,           KC_L,           _______,        _______,        
    _______,        KC_Z,           _______,        _______,        _______,        _______,                                                                        _______,        _______,        _______,        _______,        KC_SLASH,       _______,        
    _______,        _______,        XXXXXXX,        _______,        KC_LALT,                        TO(0),                                          TO(0),                          KC_LALT,        _______,        XXXXXXX,        _______,        _______,        
  ...
  [LAYER_SYM_NUM] = LAYOUT_moonlander(
    TO(0),          XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        KC_MUTE,                                        KC_MNXT,        XXXXXXX,        KC_NUMLOCK,     KC_KP_SLASH,    KC_KP_ASTERISK, KC_KP_MINUS,    _______,        
  ...
  [LAYER_MOU_NAV] = LAYOUT_moonlander(
    TO(0),          KC_MS_ACCEL0,   KC_MS_ACCEL1,   KC_MS_ACCEL2,   XXXXXXX,        XXXXXXX,        KC_MUTE,                                        KC_MPRV,        KC_PAUSE,       KC_PSCREEN,     KC_INSERT,      KC_SCROLLLOCK,  _______,        _______,        
    _______,        KC_MS_WH_LEFT,  KC_MS_WH_DOWN,  KC_MS_WH_UP,    KC_MS_WH_RIGHT, XXXXXXX,        KC_VOLU,                                        KC_MNXT,        XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        _______,        _______,        
    KC_CAPSLOCK,    KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_UP,       KC_MS_RIGHT,    XXXXXXX,        KC_VOLD,                                        KC_MPLY,        KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       _______,        _______,        
