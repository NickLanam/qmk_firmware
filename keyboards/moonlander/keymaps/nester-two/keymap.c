...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_GAME] = LAYOUT_moonlander(
    _______,        _______,        _______,        _______,        _______,        _______,        SH_OS,                          SH_OS,          _______,        _______,        _______,        _______,        _______,        _______,        
    ...
    _______,        XXXXXXX,        _______,        _______,        KC_LALT,                        TO(0),                          _______,                        KC_GRAVE,       _______,        _______,        XXXXXXX,        _______,        
